...
#-----------------------------------------------Alexabot/services/telethonuserbot.py (ENV)-------------------------------------------------------    
...
pbot = Client("Alexapbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from Alexabot.modules.helper_funcs.handlers import (
