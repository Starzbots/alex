...
import Alexabot.modules.sql.global_bans_sql as gban_sql
import Alexabot.modules.sql.users_sql as user_sql
from Alexabot import DEV_USERS, OWNER_ID, dispatcher
