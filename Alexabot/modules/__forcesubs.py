...
from Alexabot import DRAGONS as SUDO_USERS
from Alexabot import pbot
from Alexabot.modules.sql_extended import forceSubscribe_sql as sql
            ...
            try:
                ...
                try:
                    sent_message = message.reply_text(
                        "Welcome {} 🙏 \n **You havent joined our @{} Channel yet** �😞 \n \nJoin [Our Channel](https://t.me/{}) and hit the **UNMUTE ME** Button. \n \n ".format(
...
__help__ = """
*Force Subscribe:*
❍ Alexa can mute members who are not subscribed your channel until they subscribe
