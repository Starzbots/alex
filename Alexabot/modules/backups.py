...
import Alexabot.modules.sql.notes_sql as sql
from Alexabot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Alexabot.__main__ import DATA_IMPORT
from Alexabot.modules.helper_funcs.chat_status import user_admin
from Alexabot.modules.helper_funcs.alternate import typing_action

# from Alexabot.modules.rules import get_rules
import Alexabot.modules.sql.rules_sql as rulessql

# from Alexabot.modules.sql import warns_sql as warnssql
import Alexabot.modules.sql.blacklist_sql as blacklistsql
from Alexabot.modules.sql import disable_sql as disabledsql

# from Alexabot.modules.sql import cust_filters_sql as filtersql
# import Alexabot.modules.sql.welcome_sql as welcsql
import Alexabot.modules.sql.locks_sql as locksql
from Alexabot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Alexabot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Alexabot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Alexabot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Alexabot{}.backup".format(chat_id))  # Cleaning file
